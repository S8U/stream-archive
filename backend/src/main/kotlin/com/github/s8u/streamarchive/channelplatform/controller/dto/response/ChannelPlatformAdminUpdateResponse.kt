...
@Schema(description = "채널 플랫폼 수정 응답 (관리자)")
data class ChannelPlatformAdminUpdateResponse(
    ...
    companion object {
        fun from(result: ChannelPlatformAdminUpdateResult): ChannelPlatformAdminUpdateResponse {
            return ChannelPlatformAdminUpdateResponse(
                id = result.id,
                channel = ChannelInfo(
