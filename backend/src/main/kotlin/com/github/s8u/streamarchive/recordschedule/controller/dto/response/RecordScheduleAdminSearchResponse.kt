...
@Schema(description = "녹화 스케줄 목록 응답 (관리자)")
data class RecordScheduleAdminSearchResponse(
    ...
    companion object {
        fun from(result: RecordScheduleAdminSearchResult): RecordScheduleAdminSearchResponse {
            return RecordScheduleAdminSearchResponse(
                id = result.id,
                channel = ChannelInfo(
