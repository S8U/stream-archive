 ...
 * 채널 수정 결과 (관리자)
 */
data class ChannelAdminUpdateResult(
    val id: Long,
    val uuid: String,
    val name: String,
    ...
    companion object {
        fun from(channel: Channel, profileUrl: String, totalVideoFileSize: Long = 0): ChannelAdminUpdateResult {
            return ChannelAdminUpdateResult(
                id = channel.id!!,
                uuid = channel.uuid,
                name = channel.name,
