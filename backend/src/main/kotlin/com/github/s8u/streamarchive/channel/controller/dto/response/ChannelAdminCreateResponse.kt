...
@Schema(description = "채널 생성 응답 (관리자)")
data class ChannelAdminCreateResponse(
    ...
    companion object {
        fun from(result: ChannelAdminCreateResult): ChannelAdminCreateResponse {
            return ChannelAdminCreateResponse(
                id = result.id,
                uuid = result.uuid,
                name = result.name,
