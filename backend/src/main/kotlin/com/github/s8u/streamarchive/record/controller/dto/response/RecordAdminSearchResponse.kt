...
@Schema(description = "녹화 기록 목록 응답 (관리자)")
data class RecordAdminSearchResponse(
    ...
    companion object {
        fun from(result: RecordAdminSearchResult): RecordAdminSearchResponse {
            return RecordAdminSearchResponse(
                id = result.id,
                channel = ChannelInfo(
