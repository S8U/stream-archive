...
@Schema(description = "동영상 수정 응답 (관리자)")
data class VideoAdminUpdateResponse(
    ...
    companion object {
        fun from(result: VideoAdminUpdateResult): VideoAdminUpdateResponse {
            return VideoAdminUpdateResponse(
                id = result.id,
                uuid = result.uuid,
                channel = ChannelInfo(
