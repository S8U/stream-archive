...
@Schema(description = "채널 수정 응답 (관리자)")
data class ChannelAdminUpdateResponse(
    ...
    companion object {
        fun from(result: ChannelAdminUpdateResult): ChannelAdminUpdateResponse {
            return ChannelAdminUpdateResponse(
                id = result.id,
                uuid = result.uuid,
                name = result.name,
