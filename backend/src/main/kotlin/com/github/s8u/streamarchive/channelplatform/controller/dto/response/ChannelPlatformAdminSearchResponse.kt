...
@Schema(description = "채널 플랫폼 목록 응답 (관리자)")
data class ChannelPlatformAdminSearchResponse(
    ...
    companion object {
        fun from(result: ChannelPlatformAdminSearchResult): ChannelPlatformAdminSearchResponse {
            return ChannelPlatformAdminSearchResponse(
                id = result.id,
                channel = ChannelInfo(
