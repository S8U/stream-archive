...
import com.github.s8u.streamarchive.domain.enums.PlatformType
import com.github.s8u.streamarchive.domain.enums.RecordScheduleType
...
class RecordSchedule(
    ...
    @Column(nullable = false)
    @Comment("녹화 스케줄 유형")
    val recordScheduleType: RecordScheduleType,
