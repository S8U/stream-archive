...
@Schema(description = "채널 목록 응답 (관리자)")
data class ChannelAdminSearchResponse(
    ...
    companion object {
        fun from(result: ChannelAdminSearchResult): ChannelAdminSearchResponse {
            return ChannelAdminSearchResponse(
                id = result.id,
                uuid = result.uuid,
                name = result.name,
