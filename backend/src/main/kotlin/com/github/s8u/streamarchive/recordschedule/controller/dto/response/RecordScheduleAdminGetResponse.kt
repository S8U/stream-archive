...
@Schema(description = "녹화 스케줄 단건 응답 (관리자)")
data class RecordScheduleAdminGetResponse(
    ...
    companion object {
        fun from(result: RecordScheduleAdminGetResult): RecordScheduleAdminGetResponse {
            return RecordScheduleAdminGetResponse(
                id = result.id,
                channel = ChannelInfo(
