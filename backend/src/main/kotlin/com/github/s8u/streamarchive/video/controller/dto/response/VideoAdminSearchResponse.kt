...
@Schema(description = "동영상 목록 응답 (관리자)")
data class VideoAdminSearchResponse(
    ...
    companion object {
        fun from(result: VideoAdminSearchResult): VideoAdminSearchResponse {
            return VideoAdminSearchResponse(
                id = result.id,
                uuid = result.uuid,
                channel = ChannelInfo(
