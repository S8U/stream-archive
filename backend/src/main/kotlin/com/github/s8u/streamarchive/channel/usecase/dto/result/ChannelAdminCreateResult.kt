 ...
 * 채널 생성 결과 (관리자)
 */
data class ChannelAdminCreateResult(
    val id: Long,
    val uuid: String,
    val name: String,
    ...
    companion object {
        fun from(channel: Channel, profileUrl: String, totalVideoFileSize: Long = 0): ChannelAdminCreateResult {
            return ChannelAdminCreateResult(
                id = channel.id!!,
                uuid = channel.uuid,
                name = channel.name,
