...
@Schema(description = "채널 플랫폼 상세 응답 (관리자)")
data class ChannelPlatformAdminGetResponse(
    ...
    companion object {
        fun from(result: ChannelPlatformAdminGetResult): ChannelPlatformAdminGetResponse {
            return ChannelPlatformAdminGetResponse(
                id = result.id,
                channel = ChannelInfo(
