...
@Schema(description = "녹화 스케줄 생성 응답 (관리자)")
data class RecordScheduleAdminCreateResponse(
    ...
    companion object {
        fun from(result: RecordScheduleAdminCreateResult): RecordScheduleAdminCreateResponse {
            return RecordScheduleAdminCreateResponse(
                id = result.id,
                channel = ChannelInfo(
